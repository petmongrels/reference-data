		...
		<div id="list-panel" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="uuid" title="${message(code: 'panel.uuid.label', default: 'Uuid')}" />
				...
				<g:each in="${panelInstanceList}" status="i" var="panelInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: panelInstance, field: "uuid")}</td>
			...
			<div class="pagination">
				<g:paginate total="${panelInstanceCount ?: 0}" />
			</div>
		</div>
	</body>
</html>
